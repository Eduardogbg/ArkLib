...
def RingSwitching_SumcheckMultParam :
  Sumcheck.Structured.SumcheckMultiplierParam L ℓ' (RingSwitchingBaseContext κ L K ℓ) :=
...
private lemma fixFirstVariablesOfMQP_zero_eq
    ...
    Binius.BinaryBasefold.fixFirstVariablesOfMQP (L := L) (ℓ := ℓ') (v := (0 : Fin (ℓ' + 1))) H
...
private lemma projectToMidSumcheckPoly_zero_eq_computeInitial
  ...
  have h_fix0 :
      Binius.BinaryBasefold.fixFirstVariablesOfMQP (L := L) (ℓ := ℓ')
        (v := (0 : Fin (ℓ' + 1)))
