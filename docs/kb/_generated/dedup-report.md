...
- `ArkLib` — 294 files, 5058 declarations

## Same short-name across multiple files (139 groups)
...
- `def ToyProblem.Spec.reduction` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:346](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L346) — Honest reduction for Construction 6.2: the package `{prover, verifier}` over the bundled-input `Redu
- `def ToyProblem.SimplifiedIOR.reduction` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:190](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L190) — Honest reduction for Construction 6.9.
...
- `def ToyProblem.Spec.oracleVerifier` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:442](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L442) — Oracle verifier for Construction 6.2. Queries the prover's message `g` once and the two oracle codew
...
- `def ToyProblem.Spec.oracleReduction` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:462](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L462) — Honest oracle reduction for Construction 6.2: the `OracleProver` / `OracleVerifier` pair packaged as
...
- `def ToyProblem.Spec.verifier` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:332](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L332) — Honest verifier for Construction 6.2. Takes the bundled input `(stmt, oStmt) = ((v, μ₁, μ₂), (f₁, f₂
- `def ToyProblem.SimplifiedIOR.verifier` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:179](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L179) — Honest verifier for Construction 6.9. Reads `γ` from the transcript and produces the new statement `
...
- `def ToyProblem.Spec.OracleStatement` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:147](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L147) — Oracle statements of Construction 6.2: the two purported codewords `f₁, f₂ : ι → F`. The verifier on
...
- `def ToyProblem.Spec.pSpec` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:180](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L180) — Protocol specification for Construction 6.2: three rounds, in the order V → P  (γ : F)            --
- `def ToyProblem.SimplifiedIOR.pSpec` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:126](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L126) — Protocol specification for Construction 6.9: a single `V → P` round sending the combination randomne
...
- `def ToyProblem.Spec.oracleProver` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:394](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L394) — Same as `prover` but exposed at the `OracleProver` signature. The underlying `Prover` is identical (
...
- `def ToyProblem.Spec.prover` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:288](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L288) — Honest prover for Construction 6.2. After receiving the combination randomness `γ`, the prover sends
- `def ToyProblem.SimplifiedIOR.prover` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:148](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L148) — Honest prover for Construction 6.9. After receiving `γ`, sets the new witness `M_new := M₀ + γ·M₁` a
...
- `def ToyProblem.Spec.Witness` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:155](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L155) — Honest witness: the underlying messages `M₁, M₂ : Fin k → F` whose encodings are the oracle codeword
...
- `def ToyProblem.Spec.Statement` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:141](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L141) — Input (explicit) statement of Construction 6.2: the linear-constraint vector `v ∈ F^k` and the two c
...
- `def disagreementSet` [ArkLib/Data/CodingTheory/ProximityGap/DG25/MainResults.lean:64](../../../ArkLib/Data/CodingTheory/ProximityGap/DG25/MainResults.lean#L64) — The set D = Δ^{2m}(U, V), columns where U₀≠V₀ or U₁≠V₁. Specialisation of the canonical `Code.disagr
...
- `theorem ToyProblem.Spec.oracleReduction_perfectCompleteness` [ArkLib/ProofSystem/ToyProblem/Spec/Completeness.lean:138](../../../ArkLib/ProofSystem/ToyProblem/Spec/Completeness.lean#L138) — **Honest completeness for Construction 6.2** (protocol-level form). The honest oracle reduction is p
...
- `def ToyProblem.Spec.OutputStatement` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:160](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L160) — Output statement: the IOR is a yes/no test — accept (return `()`) or short-circuit to `none` via `Op
- `def ToyProblem.SimplifiedIOR.OutputStatement` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:90](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L90) — Output statement for C6.9: the new `(v, μ_new)` pair. The constraint count drops from 2 to 1 (a sing
...
- `def coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:730](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L730) — The final oracle reduction that composes sumcheckFold with finalSumcheckStep
...
- `def coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:714](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L714) — The final oracle verifier that composes sumcheckFold with finalSumcheckStep
...
- `def ToyProblem.Spec.accepts` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:213](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L213) — The §6.1 decision predicate, factored out so completeness proofs and the verifier object share the s
...
- `def ToyProblem.Spec.OutputOracleStatement` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:164](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L164) — Output oracle statement: the IOR has no output oracle component.
- `def ToyProblem.SimplifiedIOR.OutputOracleStatement` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:95](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L95) — Output oracle statement: the single combined codeword `f_new := f₁ + γ·f₂ : ι → F`.

### `OutputWitness` (2 declarations, 2 files)

- `def ToyProblem.Spec.OutputWitness` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:168](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L168) — Output witness: empty.
- `def ToyProblem.SimplifiedIOR.OutputWitness` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:99](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L99) — Output witness for C6.9: the combined message `M_new := M₁ + γ·M₂`.
...
- `def ReedSolomon.constrainedCode` [ArkLib/Data/CodingTheory/ReedSolomon.lean:754](../../../ArkLib/Data/CodingTheory/ReedSolomon.lean#L754) — Definition 4.5, WHIR[ACFY24] Constrained Reed-Solomon codes are smooth codes whose decoded `m`-varia
- `def ToyProblem.constrainedCode` [ArkLib/ProofSystem/ToyProblem/ConstrainedCode.lean:109](../../../ArkLib/ProofSystem/ToyProblem/ConstrainedCode.lean#L109) — **The constrained code** (scalar alphabet `A = F`). Adjoin the linear-constraint value `⟨m, v⟩ = ∑ j

### `coreInteractionOracleRbrKnowledgeError` (2 declarations, 2 files)

- `def coreInteractionOracleRbrKnowledgeError` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:768](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L768) — (no docstring)
...
- `theorem coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:750](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L750) — Perfect completeness for the core interaction oracle reduction
...
- `theorem coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:777](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L777) — Round-by-round knowledge soundness for the core interaction oracle verifier
...
- `def Code.minDist` [ArkLib/Data/CodingTheory/Basic/Distance.lean:219](../../../ArkLib/Data/CodingTheory/Basic/Distance.lean#L219) — (no docstring)
- `alias ReedSolomon.minDist` [ArkLib/Data/CodingTheory/ReedSolomon.lean:490](../../../ArkLib/Data/CodingTheory/ReedSolomon.lean#L490) — (no docstring)
...
- `def ToyProblem.Spec.outputRelationFor` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:248](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L248) — The IOR-shaped **fixed-encoding** *relaxed* output relation (Definition 6.3). The soundness statemen
- `def ToyProblem.SimplifiedIOR.outputRelationFor` [ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean:112](../../../ArkLib/ProofSystem/ToyProblem/Spec/SimplifiedIOR.lean#L112) — The 1-arity relaxed relation `R̃¹_{C,δ}` — the output relation of Construction 6.9. Bundles the post
...
- `def MutualCorrAgreement.proximityCondition` [ArkLib/ProofSystem/Whir/MutualCorrAgreement.lean:57](../../../ArkLib/ProofSystem/Whir/MutualCorrAgreement.lean#L57) — For `parℓ` functions `fᵢ : ι → 𝔽`, distance `δ`, generator function `GenFun: 𝔽 → parℓ → 𝔽` and linea
...
### `rbrExtractor` (2 declarations, 2 files)

- `def RandomQuery.rbrExtractor` [ArkLib/ProofSystem/Component/RandomQuery.lean:228](../../../ArkLib/ProofSystem/Component/RandomQuery.lean#L228) — The round-by-round extractor is trivial since the output witness is `Unit`.
- `def ToyProblem.Spec.rbrExtractor` [ArkLib/ProofSystem/ToyProblem/Spec/General.lean:1015](../../../ArkLib/ProofSystem/ToyProblem/Spec/General.lean#L1015) — The L6.8 round-by-round extractor ([ABF26] §6.2): round 0 extracts a relaxed-relation witness by cho
...
- `def sumcheckFoldOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:550](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L550) — (no docstring)
...
- `theorem sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:605](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L605) — Perfect completeness for the core interaction oracle reduction
...
- `def sumcheckFoldOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:366](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L366) — (no docstring)
...
- `theorem sumcheckFoldOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:693](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L693) — Round-by-round knowledge soundness for the sumcheck fold oracle verifier
...
- **1.00** `coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:730](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L730) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:639](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L639)
...
- **1.00** `coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:750](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L750) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:661](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L661)
...
- **1.00** `coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:714](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L714) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:621](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L621)
...
- **1.00** `coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:777](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L777) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleVerifier_rbrKnowledgeSoundness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:696](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L696)
...
- **1.00** `sumcheckFoldOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean:605](../../../ArkLib/ProofSystem/Binius/BinaryBasefold/CoreInteractionPhase.lean#L605) vs `Binius.FRIBinius.CoreInteractionPhase.coreInteractionOracleReduction_perfectCompleteness` [ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean:661](../../../ArkLib/ProofSystem/Binius/FRIBinius/CoreInteractionPhase.lean#L661)
    - a: Perfect completeness for the core interaction oracle reduction
    - b: Perfect completeness for the core interaction oracle reduction
